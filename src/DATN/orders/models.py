...
class Order(models.Model):
    ...
    district = models.CharField(max_length=50, blank=True, null=True, verbose_name='Quận/Huyện')
    ward = models.CharField(max_length=50, blank=True, null=True, verbose_name='Phường/Xã')
    order_note = models.CharField(max_length=100, blank=True, null=True, verbose_name='Ghi chú đơn hàng')
